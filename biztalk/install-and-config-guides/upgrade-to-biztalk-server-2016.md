...
| Stop the BizTalk and Windows Services |                                                                                            - BizTalk Service BizTalk Group:  <em><Application_Name></em><br/>- BizTalk Base EDI Service<br/>- Rule Engine Update Service<br/>- World Wide Web Publishing Service<br/><br/><strong>NOTE</strong><br/>If you have any BizTalk Server accelerators installed, stop the HL7 Logging Service.                                                                                            |
...
|  Configure SQL Server Database Mail   |                                                                                                                Applies only if you use BAM Alert definitions with SQL Server Notification Services.<br/><br/><strong>Before the upgrade</strong> (in this topic) lists the specific steps.<br/><br/>Otherwise, recreate the BAM Alert definitions after you upgrade.                                                                                                                |
...
To verify if the upgrade is successful, open <strong>Programs and Features</strong> and look for [!INCLUDE [bts2016_md](../includes/bts2016-md.md)]. If it’s listed, setup succeeded.
