...
|                BizTalk &#124; Configure Functoid Inputs<br /><br /> Opens the <strong>Configure \<Functoid\> Functoid</strong> dialog where you can configure the input parameters for the selected functoid.                |                      CTRL+M, CTRL+I<br /><br /> Select the functoid + ENTER                       |
