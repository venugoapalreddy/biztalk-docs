...
2. In the [!INCLUDE [btsVStudioNoVersion](../includes/btsvstudionoversion-md.md)] Properties window, set the <strong>Source Links</strong> property to one of the following choices:  
