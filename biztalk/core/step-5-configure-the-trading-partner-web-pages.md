...
4. In the <strong>Executable</strong> field, click the <strong>ellipsis (…)</strong> button and browse to [!INCLUDE [btsBiztalkServerPath](../includes/btsbiztalkserverpath-md.md)]\HttpReceive. Select <strong>BtsHttpReceive.dll</strong>, and then click <strong>OK</strong>.  
...
11. Click the <strong>ellipsis (…)</strong> button and browse to [!INCLUDE [btsBiztalkServerPath](../includes/btsbiztalkserverpath-md.md)]SDK\AS2 Tutorial\Fabrikam for the <strong>Physical path</strong>.  
...
4. Click the <strong>ellipsis (…)</strong> button and browse to [!INCLUDE [btsBiztalkServerPath](../includes/btsbiztalkserverpath-md.md)]HttpReceive for the <strong>Physical path</strong>.  
