...
- In Internet Explorer, in the <strong>Address</strong> box, type the URL for the Web service using the format <strong>http://<em>servername</em>/<em>apppath</em>/<em>webservicename</em>.asmx</strong>.  
