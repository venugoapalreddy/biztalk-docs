...
- <strong>Record Node Properties</strong> and <strong>Group Order Type (Node Property of All Schemas)</strong> [!INCLUDE [ui-guidance-developers-reference](../includes/ui-guidance-developers-reference.md)]
