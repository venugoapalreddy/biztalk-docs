...
2. Launch the BizTalk Configuration Program. Click <strong>Start</strong>, point to <strong>All Programs</strong>, click [!INCLUDE [btsBizTalkServerStartMenuItemui](../includes/btsbiztalkserverstartmenuitemui-md.md)], and then click <strong>BizTalk Server Configuration</strong>.  
