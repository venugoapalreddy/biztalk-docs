...
## Usage  
 <strong>BTSTask AddResource</strong> [<strong>/ApplicationName:"</strong><em>value</em><strong>"</strong>] <strong>/Type:System.BizTalk:BizTalkBinding/Property:TargetEnvironment="</strong><em>value</em><strong>"</strong> [<strong>/Overwrite</strong>] <strong>/Source:</strong><em>value</em> [<strong>/Server:</strong><em>value</em>] [<strong>/Database:</strong><em>value</em>]  
