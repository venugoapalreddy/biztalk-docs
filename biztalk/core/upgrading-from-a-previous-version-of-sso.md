...
3. Update the master secret server by running [!INCLUDE [btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] setup, choosing <strong>Custom Installation</strong>, and then selecting <strong>Enterprise Single Sign-On</strong>.  
