...
2. Type the following command, substituting the appropriate values, as described in the following table:  
    ...
    <strong>BTSTask ExportBindings /Destination:</strong> <em>value</em> <strong>/AssemblyName:</strong> <em>value</em> [<strong>/GlobalParties</strong>] [<strong>/Server:</strong><em>value</em>] [<strong>/Database:</strong><em>value</em>]  
