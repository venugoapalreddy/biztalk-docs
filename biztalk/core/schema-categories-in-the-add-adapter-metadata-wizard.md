...
```  
 ...
 For information about running the Add Adapter Metadata Wizard, see the <strong>Add Adapter Metadata Wizard Dialog Box</strong> [!INCLUDE [ui-guidance-developers-reference](../includes/ui-guidance-developers-reference.md)].