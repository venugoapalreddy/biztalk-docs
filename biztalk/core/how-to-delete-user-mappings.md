...
3. Type <strong>ssomanage –deletemapping <em>\<domain\></em>\\<em>\<username\></em> *\<application name\></strong><em>, where *\<domain\></em> is the Windows domain for the user account, <em>\<username\></em> is the Windows user name, and \<<em>application name</em>\> is the specific application for which you want to remove the user mapping.  
...
3. Type <strong>ssoclient –deletemapping *\<application name\></strong><em>, where *\<application name\></em> is the name of the affiliate application you want to remove the user mapping for.  
