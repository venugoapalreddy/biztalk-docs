...
1. Click <strong>Start</strong>, select <strong>All Programs</strong>, select [!INCLUDE [btsBizTalkServerStartMenuItemui](../includes/btsbiztalkserverstartmenuitemui-md.md)], and then select <strong>BizTalk Server Administration</strong>.  
...
4. In the **Add Adapter** dialog box, do the following.  
   ...
   |         Use this         |                             To do this                             |
   |--------------------------|--------------------------------------------------------------------|
   |  <strong>Name</strong>   |                   Type <strong>Static</strong>.                    |
   | <strong>Adapter</strong> | Select <strong>Static DotNetFile</strong> from the drop-down list. |
   | <strong>Comment</strong> |               Type <strong>Sample Adapter</strong>.                |
...
1. Click <strong>Start</strong>, select <strong>All Programs</strong>, select [!INCLUDE [btsBizTalkServerStartMenuItemui](../includes/btsbiztalkserverstartmenuitemui-md.md)], and select <strong>BizTalk Server Administration</strong>.  
...
4. Click <strong>Start</strong>, point to <strong>All Programs</strong>, point to [!INCLUDE [btsBizTalkServerStartMenuItemui](../includes/btsbiztalkserverstartmenuitemui-md.md)], and then click <strong>BizTalk Server Administration</strong>.  
...
6. In the **Connect to Existing BizTalk Server Configuration Database** dialog box, do the following.  
   ...
   |          Use this           |                                                                                           To do this                                                                                           |
   |-----------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
   | <strong>SQL Server</strong> |                                                                              Type <strong>.</strong> (a period).                                                                               |
   |  <strong>Database</strong>  | Select the name of the BizTalk Management database that was created by the Configuration Wizard. The default database name used by the Configuration Wizard is <strong>BizTalkMgmtDb</strong>. |


7. Click **OK**.  

8. Expand the <strong>BizTalk Group[<em>server name</em>]</strong> node in the [!INCLUDE [btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] Administration console, expand the <strong>Applications</strong> node, expand the  <strong>BizTalk Application 1</strong> node.  
...
10. In the **Send Port Properties** dialog box, select **General**, and do the following.  
    ...
    |            Use this             |                                                                                                                                                                                                                                                                 To do this                                                                                                                                                                                                                                                                  |
    |---------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    |      <strong>Name</strong>      |                                                                                                                                                                                                                                                     Type <strong>AdapterSend</strong>.                                                                                                                                                                                                                                                      |
    | <strong>Transport Type</strong> | Select <strong>Static</strong> from the drop-down list and click <strong>Configure</strong>.<br /><br /> -   In the <strong>Directory</strong> box, type <strong><em>\<drive\></em>:\Temp\Send</strong>.<br />-   In the <strong>File Mode</strong> box, select <strong>CreateNew</strong>.<br />-   In the <strong>File Name</strong> box, type <strong>%MessageID%.xml</strong>.<br />-   Click <strong>OK</strong>.<br />-   The <strong>URI</strong> field should show <strong><em>\<drive\></em>:\Temp\Send\\%MessageID%.xml</strong>. |
    | <strong>Send pipeline</strong>  |                                                                                                                                                                                                     Select <strong>PassThruTransmit (Microsoft.BizTalk.DefaultPipelines.PassThruTransmit)</strong>, and then click <strong>OK</strong>.                                                                                                                                                                                                     |
...
16. In the **Receive Location Properties** dialog box, do the following.  
    ...
    |             Use this              |                                                                                                                                                                                                                                                                                    To do this                                                                                                                                                                                                                                                                                     |
    |-----------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    |       <strong>Name</strong>       |                                                                                                                                                                                                                                                                   Type <strong>AdapterReceiveLocation</strong>                                                                                                                                                                                                                                                                    |
    |  <strong>Transport Type</strong>  |                                                                                                                                                                                                                          Select <strong>Static</strong> from the drop-down list and hit <strong>Configure</strong> to access these remaining properties.                                                                                                                                                                                                                          |
    |       <strong>URI</strong>        | -   Click the ellipsis button (<strong>…</strong>).<br />-   In the <strong>Number Of Files In Batch</strong> box, type <strong>20</strong>.<br />-   In the <strong>Directory</strong> box, type <strong><em>\<drive\></em>:\Temp\Receive</strong>.<br />-   Ensure the <strong>File Mask</strong> property is set to <strong>\*.xml</strong>.<br />-   In the <strong>Polling Interval</strong> box, type <strong>5</strong>, and click <strong>OK</strong>.<br />-   Ensure the <strong>URI</strong> label contains <strong><em>\<drive\></em>:\Temp\Receive\\\*.xml</strong>. |
    | <strong>Receive Handler</strong>  |                                                                                                                                                                                                                                                     Select <strong>BizTalkServerApplication</strong> from the drop-down list.                                                                                                                                                                                                                                                     |
    | <strong>Receive Pipeline</strong> |                                                                                                                                                                                                                                                            Select <strong>XMLReceive</strong> from the drop-down list.                                                                                                                                                                                                                                                            |
...
1. In [!INCLUDE [btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] Administration console, under the appropriate [!INCLUDE [btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] application, expand the <strong>Orchestrations</strong> node.  
...
3. In the **Port Binding Properties - AdapterHarness.AdapterHarnessType- Binding Configurations** dialog box, do the following.  
   ...
   |                Use this                 |                           To do this                            |
   |-----------------------------------------|-----------------------------------------------------------------|
   | <strong>AdapterFileReceivePort</strong> | Select <strong>AdapterReceive</strong> from the drop-down list. |
   |  <strong>AdapterFileSendPort</strong>   |  Select <strong>AdapterSend</strong> from the drop-down list.   |
...
1. In [!INCLUDE [btsVStudioNoVersion](../includes/btsvstudionoversion-md.md)], in Solution Explorer, right-click <strong>AdapterHarnessProject</strong>, point to <strong>Add</strong>, and then click <strong>Add Generated Items</strong>.  
