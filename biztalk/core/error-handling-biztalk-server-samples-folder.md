...
3. You should see a new file called <strong>ErrorReport_\<</strong><em>date</em>_<em>time</em><strong>\>.xml</strong> dropped into the <strong>ExpenseReportOut</strong> folder.  
