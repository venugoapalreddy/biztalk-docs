...
## What This Sample Does  
 This sample demonstrates using the <strong>BtsCatalogExplorer</strong> and <strong>ReceivePort</strong> classes from the <strong>Microsoft.BizTalk.ExplorerOM</strong> namespace to add a new receive port to [!INCLUDE [btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)]. The sample is written in Microsoft [!INCLUDE [btsVCSharp](../includes/btsvcsharp-md.md)]. A Windows PowerShell example script is also included in this topic. The sample demonstrates the following operations:  
