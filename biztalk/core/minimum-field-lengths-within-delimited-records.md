...
- <strong>Justification (Node Property of Flat File Schemas)</strong> and <strong>Minimum Length with Pad Character (Node Property of Flat File Schemas)</strong> [!INCLUDE [ui-guidance-developers-reference](../includes/ui-guidance-developers-reference.md)]
