...
## Transaction log backups  
 ...
 The mark is the string created by using <em>\<ServerName\></em><em><em>\<DatabaseName\></em>_Log\</em><em>\<LogMarkName\></em>\_<em>\<Timestamp\></em>.bak, where the <em>\<Log Mark Name\></em> is configured in the SQL Server Agent job. This mark must be used when restoring the last log to each database.  
