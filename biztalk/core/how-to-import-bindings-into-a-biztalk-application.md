...
2. Type the following command, substituting the appropriate values, as described in the following table:  
    ...
    <strong>BTSTask ImportBindings /Source:</strong> <em>value</em> [<strong>/ApplicationName:</strong><em>value</em>] [<strong>/Server:</strong><em>value</em>] [<strong>/Database:</strong><em>value</em>]  
