...
1. Open the [!INCLUDE [btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)]<strong>Custom Configuration Manager</strong>. For information about using the <strong>Custom Configuration Manager</strong>, see [Configure BizTalk Server](../install-and-config-guides/configure-biztalk-server.md).  
