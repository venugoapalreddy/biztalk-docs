...
2. On the <strong>File</strong> menu, click <strong>Save *\<Name of Map\></strong>*.  
...
2. On the **File** menu, click **Close**.  
   ...
   > [!NOTE]
   >  You can also click the close icon ([<strong>x</strong>]) in the upper-right corner of the Microsoft [!INCLUDE [btsVStudioNoVersion](../includes/btsvstudionoversion-md.md)] editing window.  
