...
2. In the console tree, expand [!INCLUDE [btsBizTalkServerAdminConsoleui](../includes/btsbiztalkserveradminconsoleui-md.md)], expand the BizTalk group into which you want to import the policy, expand <strong>Applications</strong>, and then expand <strong>\<All Artifacts\></strong>.  
...
2. Type the following command, substituting the appropriate values, as described in the following table:  
    ...
    <strong>BTSTask ImportApp /Package:</strong> <em>value</em> [<strong>/ApplicationName:</strong><em>value</em>] [<strong>/Overwrite</strong>] [<strong>/Server:</strong><em>value</em>] [<strong>/Database:</strong><em>value</em>]  
