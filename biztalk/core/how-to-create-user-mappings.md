...
3. Type <strong>ssomanage –createmappings *\<mappings file name\></strong><em>, where *\<mappings file name\></em> is the name of file that contains the user mapping(s) you want to create.  
...
3. Type <strong>ssoclient –setcredentials *\<application name \></strong><em>, where *\<application name \></em> is the name of affiliate application that the user wants to create a mapping for.  
