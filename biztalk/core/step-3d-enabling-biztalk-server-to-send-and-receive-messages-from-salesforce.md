...
1. Within the <strong>BtsSalesforceIntegration</strong> solution, create a new [!INCLUDE [btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] project. Name the project `CustomPipeline`.  
