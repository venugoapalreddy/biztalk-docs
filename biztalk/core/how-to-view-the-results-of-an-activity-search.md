...
1. Click <strong>Start</strong>, point to <strong>All Programs</strong>, click [!INCLUDE [btsBizTalkServerStartMenuItemui](../includes/btsbiztalkserverstartmenuitemui-md.md)], and then click <strong>BAM Portal Web Site</strong>.  
