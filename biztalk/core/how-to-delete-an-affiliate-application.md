...
3. Type <strong>ssomanage –deleteapp *\<application name\></strong><em>, where *\<application name\></em> is the name of the affiliate application you want to remove from the SSO database.  
