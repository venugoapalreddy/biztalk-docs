...
5. Do one of the following:  
   ...
   - To resume a single instance, in the <strong>Field Name</strong> column, in the empty drop-down list box next to the asterisk (<strong>\</strong><em>), select the **Service Name</em>* filter and then in the <strong>Value</strong> column, specify the service name.  
  
   - To resume instances in bulk, in the <strong>Field Name</strong> column, in the empty drop-down list box next to the asterisk (<strong>\</strong><em>), select **Group Results By</em>* and then in the <strong>Value</strong> column, specify the service name.  
