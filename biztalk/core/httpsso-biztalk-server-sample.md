...
5. On the **Build** menu, click **Build Solution**.  
   ...
   - <strong>Microsoft.BizTalk.ExplorerOM</strong>. By default, the Microsoft.BizTalk.ExplorerOM.dll file is located in the folder [!INCLUDE [btsBiztalkServerPath](../includes/btsbiztalkserverpath-md.md)]Developer Tools\\.  
...
9. On the final page of the wizard application, accept the default settings for <strong>Start browser at</strong> (a selected check box and a text box with the URL http://localhost/SsoSampleBizTalkHttpReceive/BTSHttpReceive.dll?<message/>), and then click <strong>Finish</strong>.  
