...
3. Navigate to the installation drive for BizTalk Server, and then navigate to <strong><</strong>`drive`<strong>>:\Program Files\Microsoft</strong> [!INCLUDE [btsBizTalkServer2006r3ui](../includes/btsbiztalkserver2006r3ui-md.md)]<strong>\SDK\Samples\AdaptersUsage\File Adapter</strong>.  
