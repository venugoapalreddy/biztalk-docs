...
1. Open the bm.exe.config file using Notepad by clicking <strong>Start</strong>, clicking <strong>Run</strong>, typing notepad [!INCLUDE [btsBiztalkServerPath](../includes/btsbiztalkserverpath-md.md)]tracking\bm.exe.config, and then clicking <strong>OK</strong>.  
