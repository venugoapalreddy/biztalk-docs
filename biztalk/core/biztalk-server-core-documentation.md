...
## Get started
<strong><a href="../core/getting-started-with-biztalk-server.md" data-raw-source="[Getting started](../core/getting-started-with-biztalk-server.md)">Getting started</a></strong> includes information about common tasks, the message engine, trading partner management using EDI and AS2, BizTalk Server tutorials, and topics for new  [!INCLUDE [btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] users.
