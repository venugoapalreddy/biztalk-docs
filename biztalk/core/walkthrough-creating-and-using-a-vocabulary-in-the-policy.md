...
- In the "To create the POVocabulary vocabulary" procedure, you changed the document type to <strong>RuleTest.PO</strong>. To see the results of this change, in [!INCLUDE [btsVStudioNoVersion](../includes/btsvstudionoversion-md.md)], in Solution Explorer, click <strong>PO.xsd</strong>. In the Properties window, note that <strong>RuleTest</strong> is the name of the namespace, and <strong>PO</strong> is the name of the <strong>Type</strong>.  
