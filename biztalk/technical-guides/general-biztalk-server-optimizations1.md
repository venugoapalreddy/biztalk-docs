...
```  
 ...
 <strong>\<add address="<https://www.contoso.com>" maxconnection="24" /\></strong>   
<strong>\<add address="<http://www.contoso.com:8080>" maxconnection="24" /\></strong>   
<strong>\<add address="http://<em>IPAddress</em>" maxconnection="24" /\></strong>  For more information about tuning IIS and ASP.NET settings for Web services, see the "ASP.NET settings that can impact HTTP  Adapter performance" section of [Configuration Parameters that Affect Adapter Performance](http://go.microsoft.com/fwlink/?LinkID=154200) (<http://go.microsoft.com/fwlink/?LinkID=154200>) in BizTalk Server 2010 Help.  
