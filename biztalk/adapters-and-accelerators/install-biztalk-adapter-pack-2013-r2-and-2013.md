...
### Prerequisites when using ADO  
 The <strong><!-- BEGIN ERROR INCLUDE: Unable to resolve [!INCLUDE[adaptersap](../includes/adaptersap-md.md)]: Path(D:/a/1/s/target_repo/biztalk/adapters-and-accelerators/install-biztalk-adapter-pack-2013-r2-and-2013.md) contains invalid char.
Parameter name: path -->[!INCLUDE[adaptersap](../includes/adaptersap-md.md)]<!--END ERROR INCLUDE --></strong> and <strong><!-- BEGIN ERROR INCLUDE: Unable to resolve [!INCLUDE[adaptersiebel](../includes/adaptersiebel-md.md)]: Path(D:/a/1/s/target_repo/biztalk/adapters-and-accelerators/install-biztalk-adapter-pack-2013-r2-and-2013.md) contains invalid char.
Parameter name: path -->[!INCLUDE[adaptersiebel](../includes/adaptersiebel-md.md)]<!--END ERROR INCLUDE --></strong> include an ADO layer (<em><!-- BEGIN ERROR INCLUDE: Unable to resolve [!INCLUDE[adoprovidersapshort](../includes/adoprovidersapshort-md.md)]: Path(D:/a/1/s/target_repo/biztalk/adapters-and-accelerators/install-biztalk-adapter-pack-2013-r2-and-2013.md) contains invalid char.
Parameter name: path -->[!INCLUDE[adoprovidersapshort](../includes/adoprovidersapshort-md.md)]<!--END ERROR INCLUDE --></em> and <em><!-- BEGIN ERROR INCLUDE: Unable to resolve [!INCLUDE[adoprovidersiebelshort](../includes/adoprovidersiebelshort-md.md)]: Path(D:/a/1/s/target_repo/biztalk/adapters-and-accelerators/install-biztalk-adapter-pack-2013-r2-and-2013.md) contains invalid char.
Parameter name: path -->[!INCLUDE[adoprovidersiebelshort](../includes/adoprovidersiebelshort-md.md)]<!--END ERROR INCLUDE --></em>). This ADO layer can be used to write an ADO.NET client to connect to an SAP system or Siebel system. You can also use the ADO layer with SQL Server Integration Services (SSIS) to import and export data from the LOB application, and SQL Server Reporting Services (SSRS) to generate reports to present data from the LOB systems.  

> [!NOTE]
>  Using the ADO Provider with SSRS is supported only for the <em><!-- BEGIN ERROR INCLUDE: Unable to resolve [!INCLUDE[adoprovidersapshort](../includes/adoprovidersapshort-md.md)]: Path(D:/a/1/s/target_repo/biztalk/adapters-and-accelerators/install-biztalk-adapter-pack-2013-r2-and-2013.md) contains invalid char.
> Parameter name: path -->[!INCLUDE[adoprovidersapshort](../includes/adoprovidersapshort-md.md)]<!--END ERROR INCLUDE --></em>.  
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <strong>BAP 2013 R2</strong>:<ul><li><!-- BEGIN ERROR INCLUDE: Unable to resolve [!INCLUDE[btsWinSrv2k12](../includes/btswinsrv2k12-md.md)]: Path(D:/a/1/s/target_repo/biztalk/adapters-and-accelerators/install-biztalk-adapter-pack-2013-r2-and-2013.md) contains invalid char.
Parameter name: path -->[!INCLUDE[btsWinSrv2k12](../includes/btswinsrv2k12-md.md)]<!--END ERROR INCLUDE --> R2<br/><!-- BEGIN ERROR INCLUDE: Unable to resolve [!INCLUDE[btsWinSrv2k12](../includes/btswinsrv2k12-md.md)]: Path(D:/a/1/s/target_repo/biztalk/adapters-and-accelerators/install-biztalk-adapter-pack-2013-r2-and-2013.md) contains invalid char.
Parameter name: path -->[!INCLUDE[btsWinSrv2k12](../includes/btswinsrv2k12-md.md)]<!--END ERROR INCLUDE --><br/>Windows 8.1<br/>Windows 7 SP1</li><li><!-- BEGIN ERROR INCLUDE: Unable to resolve [!INCLUDE[dotnet451](../includes/dotnet451-md.md)]: Path(D:/a/1/s/target_repo/biztalk/adapters-and-accelerators/install-biztalk-adapter-pack-2013-r2-and-2013.md) contains invalid char.
Parameter name: path -->[!INCLUDE[dotnet451](../includes/dotnet451-md.md)]<!--END ERROR INCLUDE --></li><li> Visual Studio 2013</li><li><!-- BEGIN ERROR INCLUDE: Unable to resolve [!INCLUDE[afproductnameshort](../includes/afproductnameshort-md.md)]: Path(D:/a/1/s/target_repo/biztalk/adapters-and-accelerators/install-biztalk-adapter-pack-2013-r2-and-2013.md) contains invalid char.
Parameter name: path -->[!INCLUDE[afproductnameshort](../includes/afproductnameshort-md.md)]<!--END ERROR INCLUDE --></li><li>Microsoft <!-- BEGIN ERROR INCLUDE: Unable to resolve [!INCLUDE[adapterpacknoversion](../includes/adapterpacknoversion-md.md)]: Path(D:/a/1/s/target_repo/biztalk/adapters-and-accelerators/install-biztalk-adapter-pack-2013-r2-and-2013.md) contains invalid char.
Parameter name: path -->[!INCLUDE[adapterpacknoversion](../includes/adapterpacknoversion-md.md)]<!--END ERROR INCLUDE --></li><li>Respective enterprise application clients and associated software. See <a href="#BKMK_SuppLOB" data-raw-source="[Supported Enterprise Application Versions](#BKMK_SuppLOB)">Supported Enterprise Application Versions</a>.</li></ul> <strong>BAP 2013</strong>:<ul><li><!-- BEGIN ERROR INCLUDE: Unable to resolve [!INCLUDE[btsWinSrv2k12](../includes/btswinsrv2k12-md.md)]: Path(D:/a/1/s/target_repo/biztalk/adapters-and-accelerators/install-biztalk-adapter-pack-2013-r2-and-2013.md) contains invalid char.
Parameter name: path -->[!INCLUDE[btsWinSrv2k12](../includes/btswinsrv2k12-md.md)]<!--END ERROR INCLUDE --><br/><!-- BEGIN ERROR INCLUDE: Unable to resolve [!INCLUDE[btsWinSvr2k8R2](../includes/btswinsvr2k8r2-md.md)]: Path(D:/a/1/s/target_repo/biztalk/adapters-and-accelerators/install-biztalk-adapter-pack-2013-r2-and-2013.md) contains invalid char.
Parameter name: path -->[!INCLUDE[btsWinSvr2k8R2](../includes/btswinsvr2k8r2-md.md)]<!--END ERROR INCLUDE --> SP1<br/>Windows 8<br/>Windows 7 SP1</li><li>Microsoft <!-- BEGIN ERROR INCLUDE: Unable to resolve [!INCLUDE[dotnet45](../includes/dotnet45-md.md)]: Path(D:/a/1/s/target_repo/biztalk/adapters-and-accelerators/install-biztalk-adapter-pack-2013-r2-and-2013.md) contains invalid char.
Parameter name: path -->[!INCLUDE[dotnet45](../includes/dotnet45-md.md)]<!--END ERROR INCLUDE --></li><li>Visual Studio 2012</li><li><!-- BEGIN ERROR INCLUDE: Unable to resolve [!INCLUDE[afproductnameshort](../includes/afproductnameshort-md.md)]: Path(D:/a/1/s/target_repo/biztalk/adapters-and-accelerators/install-biztalk-adapter-pack-2013-r2-and-2013.md) contains invalid char.
Parameter name: path -->[!INCLUDE[afproductnameshort](../includes/afproductnameshort-md.md)]<!--END ERROR INCLUDE --></li><li>Microsoft <!-- BEGIN ERROR INCLUDE: Unable to resolve [!INCLUDE[adapterpacknoversion](../includes/adapterpacknoversion-md.md)]: Path(D:/a/1/s/target_repo/biztalk/adapters-and-accelerators/install-biztalk-adapter-pack-2013-r2-and-2013.md) contains invalid char.
Parameter name: path -->[!INCLUDE[adapterpacknoversion](../includes/adapterpacknoversion-md.md)]<!--END ERROR INCLUDE --></li><li>Respective enterprise application clients and associated software. See <a href="#BKMK_SuppLOB" data-raw-source="[Supported Enterprise Application Versions](#BKMK_SuppLOB)">Supported Enterprise Application Versions</a>.</li></ul> | <strong>BAP 2013 R2</strong>:<ul><li><!-- BEGIN ERROR INCLUDE: Unable to resolve [!INCLUDE[btsWinSrv2k12](../includes/btswinsrv2k12-md.md)]: Path(D:/a/1/s/target_repo/biztalk/adapters-and-accelerators/install-biztalk-adapter-pack-2013-r2-and-2013.md) contains invalid char.
Parameter name: path -->[!INCLUDE[btsWinSrv2k12](../includes/btswinsrv2k12-md.md)]<!--END ERROR INCLUDE --> R2<br/><!-- BEGIN ERROR INCLUDE: Unable to resolve [!INCLUDE[btsWinSrv2k12](../includes/btswinsrv2k12-md.md)]: Path(D:/a/1/s/target_repo/biztalk/adapters-and-accelerators/install-biztalk-adapter-pack-2013-r2-and-2013.md) contains invalid char.
Parameter name: path -->[!INCLUDE[btsWinSrv2k12](../includes/btswinsrv2k12-md.md)]<!--END ERROR INCLUDE --><br/>Windows 8.1<br/>Windows 7 SP1</li><li><!-- BEGIN ERROR INCLUDE: Unable to resolve [!INCLUDE[dotnet451](../includes/dotnet451-md.md)]: Path(D:/a/1/s/target_repo/biztalk/adapters-and-accelerators/install-biztalk-adapter-pack-2013-r2-and-2013.md) contains invalid char.
Parameter name: path -->[!INCLUDE[dotnet451](../includes/dotnet451-md.md)]<!--END ERROR INCLUDE --></li><li><!-- BEGIN ERROR INCLUDE: Unable to resolve [!INCLUDE[afproductnameshort](../includes/afproductnameshort-md.md)]: Path(D:/a/1/s/target_repo/biztalk/adapters-and-accelerators/install-biztalk-adapter-pack-2013-r2-and-2013.md) contains invalid char.
Parameter name: path -->[!INCLUDE[afproductnameshort](../includes/afproductnameshort-md.md)]<!--END ERROR INCLUDE --></li><li>Microsoft <!-- BEGIN ERROR INCLUDE: Unable to resolve [!INCLUDE[adapterpacknoversion](../includes/adapterpacknoversion-md.md)]: Path(D:/a/1/s/target_repo/biztalk/adapters-and-accelerators/install-biztalk-adapter-pack-2013-r2-and-2013.md) contains invalid char.
Parameter name: path -->[!INCLUDE[adapterpacknoversion](../includes/adapterpacknoversion-md.md)]<!--END ERROR INCLUDE --></li><li>Respective enterprise application clients and associated software. See <a href="#BKMK_SuppLOB" data-raw-source="[Supported Enterprise Application Versions](#BKMK_SuppLOB)">Supported Enterprise Application Versions</a>.</li><li>Internet Information Services (IIS) version that comes with the operating system. KB 224609 lists the versions.</li></ul><strong>BAP 2013</strong>:<ul><li><!-- BEGIN ERROR INCLUDE: Unable to resolve [!INCLUDE[btsWinSrv2k12](../includes/btswinsrv2k12-md.md)]: Path(D:/a/1/s/target_repo/biztalk/adapters-and-accelerators/install-biztalk-adapter-pack-2013-r2-and-2013.md) contains invalid char.
Parameter name: path -->[!INCLUDE[btsWinSrv2k12](../includes/btswinsrv2k12-md.md)]<!--END ERROR INCLUDE --><br/><!-- BEGIN ERROR INCLUDE: Unable to resolve [!INCLUDE[btsWinSvr2k8R2](../includes/btswinsvr2k8r2-md.md)]: Path(D:/a/1/s/target_repo/biztalk/adapters-and-accelerators/install-biztalk-adapter-pack-2013-r2-and-2013.md) contains invalid char.
Parameter name: path -->[!INCLUDE[btsWinSvr2k8R2](../includes/btswinsvr2k8r2-md.md)]<!--END ERROR INCLUDE --> SP1<br/>Windows 8<br/>Windows 7 SP1</li><li>Microsoft <!-- BEGIN ERROR INCLUDE: Unable to resolve [!INCLUDE[dotnet45](../includes/dotnet45-md.md)]: Path(D:/a/1/s/target_repo/biztalk/adapters-and-accelerators/install-biztalk-adapter-pack-2013-r2-and-2013.md) contains invalid char.
Parameter name: path -->[!INCLUDE[dotnet45](../includes/dotnet45-md.md)]<!--END ERROR INCLUDE --></li><li><!-- BEGIN ERROR INCLUDE: Unable to resolve [!INCLUDE[afproductnameshort](../includes/afproductnameshort-md.md)]: Path(D:/a/1/s/target_repo/biztalk/adapters-and-accelerators/install-biztalk-adapter-pack-2013-r2-and-2013.md) contains invalid char.
Parameter name: path -->[!INCLUDE[afproductnameshort](../includes/afproductnameshort-md.md)]<!--END ERROR INCLUDE --></li><li>Microsoft <!-- BEGIN ERROR INCLUDE: Unable to resolve [!INCLUDE[adapterpacknoversion](../includes/adapterpacknoversion-md.md)]: Path(D:/a/1/s/target_repo/biztalk/adapters-and-accelerators/install-biztalk-adapter-pack-2013-r2-and-2013.md) contains invalid char.
Parameter name: path -->[!INCLUDE[adapterpacknoversion](../includes/adapterpacknoversion-md.md)]<!--END ERROR INCLUDE --></li><li>Respective enterprise application clients and associated software. See <a href="#BKMK_SuppLOB" data-raw-source="[Supported Enterprise Application Versions](#BKMK_SuppLOB)">Supported Enterprise Application Versions</a>.</li><li>Internet Information Services (IIS) version that comes with the operating system. KB 224609 lists the versions.</li></ul> |            Microsoft Office SharePoint Server Software Development Kit (SDK)             | Microsoft Office Servers Infrastructure Update. Download at [http://go.microsoft.com/fwlink/?LinkId=128344](http://go.microsoft.com/fwlink/?LinkId=128344). |

<a name="BKMK_SuppLOB"></a>   
## Supported enterprise application versions  

To see the specific LOB system versions that are supported by the [!INCLUDE [adapterpacknoversion](../includes/adapterpacknoversion-md.md)], see <strong><a href="http://social.technet.microsoft.com/wiki/contents/articles/17631.biztalk-server-supported-line-of-business-lob-systems.aspx" data-raw-source="[Supported Line-of-Business (LOB) systems](http://social.technet.microsoft.com/wiki/contents/articles/17631.biztalk-server-supported-line-of-business-lob-systems.aspx)">Supported Line-of-Business (LOB) systems</a></strong>. 
...
1. From the [!INCLUDE [btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] installation media, run <strong>Setup.exe</strong>.  
