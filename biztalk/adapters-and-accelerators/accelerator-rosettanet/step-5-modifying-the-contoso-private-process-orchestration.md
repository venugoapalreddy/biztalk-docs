...
2. In the Add Reference dialog box, click <strong>Browse</strong>. Move to <em>\<drive\></em>:\Program Files\Microsoft BizTalk \<version\> Accelerator for RosettaNet\Bin folder, and then select the following assemblies<strong>:</strong>  
...
12. In [!INCLUDE [btsVStudioNoVersion](../../includes/btsvstudionoversion-md.md)], on the <strong>File</strong>, click <strong>Save All</strong> to save the project.  
