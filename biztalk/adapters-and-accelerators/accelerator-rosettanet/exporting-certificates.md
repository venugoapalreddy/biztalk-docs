...
1. Click <strong>Start</strong>, click <strong>Run</strong>, type <strong>runas /user:\<host service\> mmc</strong>, where \<<em>hostservice</em>\> is the name of the service that you associated with the host service when you installed [!INCLUDE [btsCoName](../../includes/btsconame-md.md)][!INCLUDE [BTARN_CurrentVersion_FirstRef](../../includes/btarn-currentversion-firstref-md.md)], and then click <strong>OK</strong> to run the [!INCLUDE [btsCoName](../../includes/btsconame-md.md)] Management Console (MMC) in the context of the host service.  
