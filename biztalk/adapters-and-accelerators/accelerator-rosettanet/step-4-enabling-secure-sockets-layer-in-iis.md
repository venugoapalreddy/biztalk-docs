...
2. In the Internet Information Services left pane, expand <strong>\<</strong><em>computer_name</em><strong>\></strong> (<em>local computer</em>), expand <strong>Web Sites</strong>, right-click <strong>Default Web Site</strong>, and then click <strong>Properties</strong>.  
...
2. In the Internet Information Services left pane, expand <strong>\<</strong><em>computer_name</em>\> (<em>local computer</em>), expand <strong>Web Sites</strong>, right-click <strong>Default Web Site</strong>, and then click <strong>Properties</strong>.  
