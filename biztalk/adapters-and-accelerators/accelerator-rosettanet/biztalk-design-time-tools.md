...
- 3A4_MS_V02_02_PurchaseOrderRequest.xsd  
  ...
  These schemas are available at \<<em>drive</em>\>:\Program Files\\[!INCLUDE [btsCoName](../../includes/btsconame-md.md)] BizTalk \<version\> Accelerator for RosettaNet\SDK\Schemas.  
