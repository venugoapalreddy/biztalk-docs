...
After you configure the [!INCLUDE [A4SWIFT_CurrentVersion_FirstRef_md](../../includes/a4swift-currentversion-firstref-md.md)], add the account that runs the BizTalkServerApplication host instance to the <strong>A4SWIFT Users</strong> group (<em>not</em> the <strong>A4SWIFT Administrators</strong> group). 
