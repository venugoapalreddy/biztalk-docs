...
- The target namespace for each message schema is <strong>http://schemas.microsoft.com/BizTalk/Solutions/FinancialServices/SWIFT/Category*z*/MT*zxx</strong><em>, where *z</em> is the message category (first digit of the message type) and <em>zxx</em> is the message type.  
  
- The document type is <strong>MT*zxx</strong><em>, where *zxx</em> is the message type.  
