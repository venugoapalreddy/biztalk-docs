...
6. In the SWIFT Accelerator pane of the [!INCLUDE [btsOfficeNoVersion](../../includes/btsofficenoversion-md.md)][!INCLUDE [btsInpathNoVersion](../../includes/btsinpathnoversion-md.md)] 2007 window, ensure that <strong>Errors</strong> is selected. Review any errors shown in the <strong>Parse and XML Validation Errors</strong>, <strong>BRE Validation Errors</strong>, and <strong>Runtime Errors</strong> boxes.  
...
9. In the [!INCLUDE [btsOfficeNoVersion](../../includes/btsofficenoversion-md.md)][!INCLUDE [btsInpathNoVersion](../../includes/btsinpathnoversion-md.md)] 2007 window, click <strong>Submit</strong>.  
