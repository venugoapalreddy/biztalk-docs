...
6. Click **OK** to open the new project.  
    ...
    [!INCLUDE [btsVStudioNoVersion](../../includes/btsvstudionoversion-md.md)] creates an empty solution in Solution Explorer and a new blank solution in the \<<em>drive</em>:\>\labs folder.  
