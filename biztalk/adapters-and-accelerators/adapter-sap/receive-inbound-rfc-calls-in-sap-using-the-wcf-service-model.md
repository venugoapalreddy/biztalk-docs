...
### The Generated WCF Service  
 The [!INCLUDE [addadapterservrefshort](../../includes/addadapterservrefshort-md.md)] also generates a WCF service that implements the WCF service contract (<strong>Rfc</strong>). The methods of this class are stubbed. This class is generated in a separate file. You can implement your code directly in the methods of this class.  
