...
|-------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------|
|        Flat-file IDOC         |                                                         <strong>Metadata Design Time</strong><br /><br /> 1.  Set the binding property GenerateFlatFileCompatibleIdocSchema to <strong>True</strong>.<br />2.  Generate the schema for the <strong>Send</strong> operation for a specific IDOC using [!INCLUDE [consumeadapterservshort](../../includes/consumeadapterservshort-md.md)].<br /><br /> <strong>Orchestration Design Time</strong><br /><br /> 1.  Receive flat-file IDOC<br />2.  Use flat-file disassembler to convert flat-file IDOC to XML IDOC using the schema just generated.<br />3.  Set the Action to <strong>Send</strong> operation.                                                         |   Send message    |
|        Flat-file IDOC         | <strong>Metadata Design Time</strong><br /><br /> 1.  Set the binding property GenerateFlatFileCompatibleIdocSchema to <strong>True</strong>.<br />2.  Generate the schema for the <strong>SendIdoc</strong> operation from the IDOC node using [!INCLUDE [consumeadapterservshort](../../includes/consumeadapterservshort-md.md)].<br /><br /> <strong>Orchestration Design Time</strong><br /><br /> 1.  Receive flat-file IDOC<br />2.  Use flat-file disassembler to convert flat-file IDOC to XML (in this case, the XML message contains an \<idocData\> node that contains the entire flat-file Idoc message) using the schema just generated.<br />3.  Set the Action to <strong>SendIdoc</strong> operation. | SendIdoc message  |
|           XML IDOC            |                                                                                                                                                                 <strong>Metadata Design Time</strong><br /><br /> -   Generate the schema for the <strong>Send</strong> operation for a specific IDOC using [!INCLUDE [consumeadapterservshort](../../includes/consumeadapterservshort-md.md)].<br /><br /> <strong>Orchestration Design Time</strong><br /><br /> 1.  Receive XML IDOC.<br />2.  Set the Action to <strong>Send</strong> operation.                                                                                                                                                                  |   Send message    |
| Flat-file IDOC in XML message |                                                                                                                                                            <strong>Metadata Design Time</strong><br /><br /> -   Generate the schema for the <strong>SendIdoc</strong> operation from the IDOC node using [!INCLUDE [consumeadapterservshort](../../includes/consumeadapterservshort-md.md)].<br /><br /> <strong>Orchestration Design Time</strong><br /><br /> 1.  Receive XML message.<br />2.  Set the Action to <strong>SendIdoc</strong> operation.                                                                                                                                                             | SendIdoc message  |
