...
The Consume Adapter Service Add-in is installed when you install WCF LOB Adapter SDK. The Consume Adapter Service Add-in loads all the WCF-Custom bindings installed on the computer. To connect to the Oracle database using the WCF-based [!INCLUDE [adapteroracle_short](../../includes/adapteroracle-short-md.md)] in a BizTalk project, you must use the <strong>oracleDBBinding</strong>.  
...
1. To connect using the [!INCLUDE [consumeadapterservshort](../../includes/consumeadapterservshort-md.md)] in a BizTalk solution:  
   ...
   3. Click <strong>Add</strong>. The [!INCLUDE [consumeadapterservshort](../../includes/consumeadapterservshort-md.md)] opens.  
