...
1. Create a BizTalk project and generate schema for the SQLEXECUTE operation. The SQLEXECUTE operation is surfaced under the root node (/) in the <strong>Select a category</strong> pane in the [!INCLUDE [consumeadapterservlong](../../includes/consumeadapterservlong-md.md)].  
