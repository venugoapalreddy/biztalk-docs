...
> [!IMPORTANT]
>  You must generate the schema by selecting the procedure only from the <strong>Procedures</strong> node in [!INCLUDE [consumeadapterservshort](../../includes/consumeadapterservshort-md.md)].  
