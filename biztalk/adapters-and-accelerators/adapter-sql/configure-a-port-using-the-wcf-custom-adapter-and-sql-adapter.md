...
4. Right-click <strong>Send Ports</strong>, point to <strong>New</strong>, and then point to the type of port you want to configure depending on the mode of communication between [!INCLUDE [btsBizTalkServerNoVersion](../../includes/btsbiztalkservernoversion-md.md)] and SQL Server.  
...
4. Right-click <strong>Receive Ports</strong>, point to <strong>New</strong>, and click <strong>One-way Receive Port</strong> or <strong>Request Response Receive Port</strong>, depending on the mode of communication between [!INCLUDE [btsBizTalkServerNoVersion](../../includes/btsbiztalkservernoversion-md.md)] and SQL Server.  
