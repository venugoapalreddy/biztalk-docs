...
2. After you import the binding file, a send port is created under the <strong>Send Ports</strong> folder in the [!INCLUDE [btsBizTalkServerNoVersion](../../includes/btsbiztalkservernoversion-md.md)] Administration console.  
...
4. Under the <strong>Bindings</strong> box, map the logical ports of the BizTalk orchestration to the physical ports in the [!INCLUDE [btsBizTalkServerNoVersion](../../includes/btsbiztalkservernoversion-md.md)] Administration console.  
