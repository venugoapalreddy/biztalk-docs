...
```  
 ...
 In this snippet, <strong>RequestSets_SQLAPClient</strong> is the name of the WCF class in the OracleEBSBindingClient.cs generated by the [!INCLUDE [addadapterservrefshort](../../includes/addadapterservrefshort-md.md)]. <strong>REQSTG</strong> is the name of the method to invoke the request set.  
