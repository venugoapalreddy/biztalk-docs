...
- Packages  
  ...
  The synonyms for each of these artifacts are exposed alongside the respective underlying artifact in the [!INCLUDE [consumeadapterservshort](../../includes/consumeadapterservshort-md.md)], [!INCLUDE [addadapterwiz](../../includes/addadapterwiz-md.md)], and [!INCLUDE [addadapterservrefshort](../../includes/addadapterservrefshort-md.md)]. For example, the <strong>Tables</strong> node under the <strong>Schema-based view</strong> will display all the synonyms for tables along with the database tables in a schema, the <strong>Views</strong> node under the <strong>Schema-based view</strong> will display all the synonyms for views along with the database views in a schema, and so on.  
