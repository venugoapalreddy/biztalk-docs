...
1. Add a schema file to the BizTalk project in [!INCLUDE [btsVStudioNoVersion](../../includes/btsvstudionoversion-md.md)]. Right-click the solution name, point to <strong>Add</strong>, and then click <strong>New Item</strong>. In the <strong>Add New Item</strong> dialog box, from the <strong>Categories</strong> box, click <strong>Schema Files</strong>. From the <strong>Templates</strong> box, click <strong>Schema</strong>. Specify a name for the schema file and click <strong>OK</strong>.  
...
1. Add an orchestration to the BizTalk project in [!INCLUDE [btsVStudioNoVersion](../../includes/btsvstudionoversion-md.md)]. From Solution Explorer, right-click the BizTalk project name, point to <strong>Add</strong>, and then click <strong>New Item</strong>. Type a name for the BizTalk orchestration, and then click <strong>Add</strong>.  
...
5. In the **Properties** pane for the **Message_1**, do the following:  
   ...
   | Message Type | From the drop-down list, expand <strong>Schemas</strong>, and then select <em>Composite_Op.CompositeSchema.Request</em>, where Composite_Op is the name of your BizTalk project. CompositeSchema is the schema you created manually for the composite operations. |
