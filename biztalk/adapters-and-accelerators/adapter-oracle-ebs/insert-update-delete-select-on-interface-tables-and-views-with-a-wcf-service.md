...
| Interface views  |  InterfaceViews_[APP_NAME]<em>[SCHEMA]\</em>[VIEW_NAME]Client  |
...
```  
 ...
 In this snippet, <strong>InterfaceTables_FND_APPS_MS_SAMPLE_EMPLOYEEClient</strong> is the name of the WCF class in the OracleEBSBindingClient.cs generated by the [!INCLUDE [addadapterservrefshort](../../includes/addadapterservrefshort-md.md)].  
