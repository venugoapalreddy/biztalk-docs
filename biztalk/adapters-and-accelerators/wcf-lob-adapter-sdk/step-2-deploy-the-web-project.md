...
7. To verify that the Web site was correctly created, start Internet Explorer, enter  <strong>"<http://localhost/EchoWeb/EchoOutboundContract.svc>"</strong> in the address bar, and then press ENTER. A Web page that describes the EchoOutboundContractClient should appear.  
