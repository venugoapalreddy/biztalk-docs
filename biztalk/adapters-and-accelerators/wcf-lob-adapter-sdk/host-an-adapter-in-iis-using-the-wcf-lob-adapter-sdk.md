...
1. Open [!INCLUDE [btsVStudioNoVersion_md](../../includes/btsvstudionoversion-md.md)]. On the <strong>File</strong> menu, select <strong>New</strong>, and then select <strong>Web Site</strong>.  
...
11. The wizard creates a Web project and adds the following files.  
    ...
    | web.config | Contains \<<strong>endpoint</strong>\, \<<strong>bindings</strong>\>, and \<<strong>behaviors</strong>\> elements for \<<strong>system.ServiceModel</strong>\> |
