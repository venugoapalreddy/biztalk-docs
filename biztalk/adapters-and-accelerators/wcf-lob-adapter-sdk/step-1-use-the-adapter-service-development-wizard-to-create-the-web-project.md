...
4. On the <strong>Summary</strong> page, review the contracts and operations selected for this project, and then click <strong>Finish</strong>. You will be presented with the EchoWeb solution, which contains the project files created by the [!INCLUDE [afsvcdevwizshort](../../includes/afsvcdevwizshort-md.md)]  
