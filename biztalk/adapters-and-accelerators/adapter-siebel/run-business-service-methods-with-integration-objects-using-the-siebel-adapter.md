...
- <strong>Generate the schema for the EAI Siebel Adapter business service</strong>. You must use the [!INCLUDE [consumeadapterservshort](../../includes/consumeadapterservshort-md.md)] to generate the schema. Once you generate the schema, generate the XML that conforms to the schema.  
