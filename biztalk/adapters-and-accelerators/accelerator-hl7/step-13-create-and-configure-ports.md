...
4. On the **Select a Port Type** page, enter the following information, and then click **Next** to continue.  
   ...
   |                Use this                |                 To do this                 |
   |----------------------------------------|--------------------------------------------|
   |    <strong>Port Type Name</strong>     | Type <strong>SOAPReceivePortType</strong>. |
   | <strong>Communication Pattern</strong> |      Select <strong>One-Way</strong>.      |
   |  <strong>Access Restrictions</strong>  | Select <strong>Public - no limit</strong>. |
...
8. Using the **Port Configuration Wizard** as you did in steps 2 through 7, create an additional send port using the following parameters:  
   ...
   |                     Property                     |                   Parameter                   |
   |--------------------------------------------------|-----------------------------------------------|
   |      <strong>Port Properties Name</strong>       |                 MLLPSendPort                  |
   |         <strong>Port Type Name</strong>          |               MLLPSendPortType                |
   |      <strong>Communication Pattern</strong>      |                    One-Way                    |
   |       <strong>Access Restrictions</strong>       |               Public - no limit               |
   |          <strong>Port Binding</strong>           |                 Specify Later                 |
   | <strong>Port direction of communication</strong> | I'll always be sending messages on this port. |
