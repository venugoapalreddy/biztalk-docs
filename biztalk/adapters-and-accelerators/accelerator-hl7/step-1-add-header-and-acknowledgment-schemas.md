...
5. In the <strong>Location</strong> box, browse to <strong>\<</strong><em>drive</em><strong>:\>\Batching Tutorial</strong>.  
...
2. On the [!INCLUDE [btsVStudioNoVersion](../../includes/btsvstudionoversion-md.md)] command prompt, browse to the <strong>\<</strong><em>drive</em><strong>\>:\Batching Tutorial</strong> folder.  
