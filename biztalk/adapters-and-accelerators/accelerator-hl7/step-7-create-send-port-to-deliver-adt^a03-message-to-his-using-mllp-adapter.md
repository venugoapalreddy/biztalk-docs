...
2. In the Send Port Properties dialog box, do the following actions:  
   ...
   |            Use this             |                                             To do this                                              |
   |---------------------------------|-----------------------------------------------------------------------------------------------------|
   |      <strong>Name</strong>      |                              Type <strong>Tutorial_MllpSend</strong>.                               |
...
3. In the MLLP Transport Properties dialog box, do the following actions and then click **OK**.  
   ...
   |             Use this             |            To do this            |
   |----------------------------------|----------------------------------|
   | <strong>Connection Name</strong> | Type <strong>1WaySend</strong>.  |
   |      <strong>Host</strong>       | Type <strong>localhost</strong>. |
   |      <strong>Port</strong>       |   Type <strong>14000</strong>.   |
