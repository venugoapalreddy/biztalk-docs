...
4. In the <strong>Assembly Key File</strong> dialog box, browse to \<<em>drive</em>\>:\Program Files\\[!INCLUDE [btsCoName](../../includes/btsconame-md.md)] BizTalk \<version\> Accelerator for HL7\SDK\Interrogative Tutorial, click <strong>key.snk</strong>, and then click <strong>Open</strong>.  
