 ...
 **CodePageLanguage**  
 ...
 <strong>PrinterDeviceName</strong>  
 Data Type: <strong>String</strong> Qualifiers: <strong>MAXLEN(256)</strong>Access Type: Read/Write  
  
 The name of the destination printer.  
  
 <strong>CodePageCustomFile</strong>  
 Data Type: <strong>String</strong> Qualifiers: <strong>MAXLEN(256)</strong>Access Type: Read/Write  
  
 The file name if a custom code page is to be used.  
  
 <strong>PrinterFile</strong>  
 Data Type: <strong>String</strong> Qualifiers: <strong>MAXLEN(256)</strong>Access Type: Read/Write  
 ...
 **true** to indicate that the print job will be sent to a file; otherwise, **false**. Note that you must still configure a destination printer.  
 ...
 Data Type: <strong>String</strong> Qualifiers: <strong>MAXLEN(31)</strong>Access Type: Read/Write  
 ...
 **true** to override the host commands; otherwise, **false**.  
 ...
 <strong>LeftMargin</strong>  
 Data Type: <strong>sint32</strong> Qualifiers: <strong>MINVALUE(0), MAXVALUE(255)</strong>Access Type: Read/Write  
