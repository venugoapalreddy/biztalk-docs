...
2. On the <strong>Tools</strong> menu, click <strong>3270 Client</strong>. This launches the [!INCLUDE [hisHostIntServNoVersion](../includes/hishostintservnoversion-md.md)] 3270 Client application.  
