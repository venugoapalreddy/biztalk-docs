...
|----------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------|
|                     <strong>RMTNETID</strong> (usually; often set to APPN); <strong>RMTCPNAME</strong>                     |    <strong>Local Network Name</strong> and <strong>Local Control Point Name</strong> (configured on the server)    |
| <strong>RMTNETID</strong> (often set to APPN); <strong>CP Name</strong> (shown in the "Display network attributes" screen) | <strong>Remote Network Name</strong> and <strong>Remote Control Point Name</strong> (configured on the connection) |
